package com.visma.fishing.auxiliary;
...
public class Messages {
    ...
    public static final String CONFIGURATION_SAVE_SUCCESS_MSG = "Successfully saved configuration with id ";
    public static final String CONFIGURATION_UPDATE_SUCCESS_MSG = "Successfully updated configuration with id ";
    public static final String CONFIGURATION_REMOVED_SUCCESS_MSG = "Removed configuration with id ";
    public static final String CONFIGURATION_FIND_FAILED_MSG = "Could not find configuration with id ";
